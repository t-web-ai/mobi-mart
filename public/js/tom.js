    ...
    class ue extends (function (e) {
        ...
        setup() {
            ...
            (null === t.maxItems || t.maxItems > 1) &&
                ...
                t.load &&
                    t.loadThrottle &&
                    (t.load = te(t.load, t.loadThrottle)),
        ...
        sync(e = !0) {
            const t = this,
                i = e
                    ? ce(t.input, { delimiter: t.settings.delimiter })
                    : t.settings;
        ...
        setTextboxValue(e = "") {
            ...
            t.value !== e &&
                ((t.value = e), D(t, "update"), (this.lastValue = e));
        }
        getValue() {
        ...
        refreshOptions(e = !0) {
            ...
            for (
                ...
                for (
                    ...
                    let e = u[o];
                    void 0 === e &&
                        ((e = document.createDocumentFragment()), p.push(o)),
                        i > 0 &&
                            ((d = d.cloneNode(!0)),
                            G(d, {
                                id: l.$id + "-clone-" + i,
            ...
            (e.settings.shouldOpen = !0),
                e.hook("before", "setup", () => {
                    (e.focus_node = e.control),
                        H(e.control_input, "dropdown-input");
