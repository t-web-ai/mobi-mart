...
<div class="list-group fw-bold p-2" id="parent">
  <div class="list-group-item">
    <div class="d-flex justify-content-between align-items-center">
      ...
      <i class="dropdown-toggle fs-5 me-1" data-bs-target="#about" data-bs-toggle="collapse"></i>
    </div>
    <div class="collapse text-muted" id="about" data-bs-parent="#parent">
  ...
  <div class="list-group-item">
    <div class="d-flex justify-content-between align-items-center">
      ...
      <i class="dropdown-toggle fs-5 me-1" data-bs-target="#link" data-bs-toggle="collapse"></i>
    </div>
