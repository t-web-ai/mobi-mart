<x-auth.admin.layout title="Manage Products" name="Colors">
  ...
  <div class="p-3 row">
    ...
    <div class="col-6 col-md-3 col-lg-2">
      <a href="{{ route('admin.products.color.add') }}" class="text-decoration-none text-body">
    ...
    @if (count($colors))
      <div class="mt-2">
        <x-auth.admin.products.tables.color :colors="$colors" />
        <div>{{ $colors->links() }}</div>
      </div>
    @else
      <div class="mt-5 d-flex justify-content-center">
        <div class="text-center p-4">
          <h5 class="text-muted mb-0">No colors found.</h5>
        </div>
      </div>
    @endif
